...
namespace test1
{
    public partial class Form3 : Form
    {
        ...
        {
            InitializeComponent();
            this.Paint += new PaintEventHandler(this.Form2_Paint);
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Random Wheel";

            // Create a TextBox for user to input options
            ...
            // Create a Button to start spinning
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (angularVelocity <= 0.01f) // 如果角速度已經很小，即將停止
            {
                ...
                int winningIndex = (int)((360 - finalAngle + anglePerOption / 2) % 360 / anglePerOption) % options.Length;
